...
if(isset($_POST['add-btn']))
{
    ...
    if($password==$confirm_password)
    {
       ...
       {
           $user_query="INSERT INTO user (fname, lname, ffname, flname, fnid, email, dob, gender, division, password, role_as) VALUES ('$fname','$lname','$ffname', '$flname', '$fnid','$email', '$dob', '$gender', '$division', '$password', '1' )";
