...
<div class="container-fluid px-4">
    <h4 class="mt-4">THE XYZ HOSPITAL ADMIN PANEL</h4>
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active">Vaccinators</li>
        </ol>
    <form action="add-vaccinator.php" method="POST">
        <input type="hidden" name="add-id" value="<?php echo $row['u_id']; ?>">
            <button type="submit" name="add" class="btn btn-primary">Add Vaccinator</button>
    </form>
    <br>
    <div class="row">
      <div class = "col-md-12">
               ...
               <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <form action="edit-vaccinator.php" method="POST">
